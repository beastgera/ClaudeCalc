...
public static class GearItemDatabase
{
    ...
    public static readonly IReadOnlyList<GearItem> Items = new List<GearItem>
    {
        ...
        new("HEAD_LEATHER_DRAGON", "Dragonhide Hood", 8, Leather, 0, null, "Lymhurst", "ARTEFACT_HEAD_LEATHER_DRAGON", "Dragon Scale Padding", 1, null, null, 0, Hunter, 250),
        new("ARMOR_LEATHER_DRAGON", "Dragonhide Jacket", 16, Leather, 0, null, "Thetford", "ARTEFACT_ARMOR_LEATHER_DRAGON", "Dragon Scale Leather", 1, null, null, 0, Hunter, 250),
        new("SHOES_LEATHER_DRAGON", "Dragonhide Shoes", 8, Leather, 0, null, "Lymhurst", "ARTEFACT_SHOES_LEATHER_DRAGON", "Dragon Scale Bindings", 1, null, null, 0, Hunter, 250),
